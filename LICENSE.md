...
SPDX-License-Identifier: LicenseRef-LlamaPanama-Commercial

Copyright (c) 2025 Towsif Ahamed

LlamaPanama is **dual-licensed**:
...
2) **Commercial License (Proprietary)**
   ...
   (e.g., attribution in credits/docs and/or a note in your OSS/compliance page) that the industry is using LlamaPanama.
...
Notably, this project is designed to integrate with **llama.cpp**, which is licensed under the MIT License.
Users and licensees are responsible for complying with llama.cpp's license terms when using it with LlamaPanama.
